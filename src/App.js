...
import AddNewDeviceForm from './components/NewDevice/ImportDeviceForm'
  ...
  if(_token !== ''){
    return (
      <div className="App">
        ...
        {/* ADD NEW DEVICE */}
        { (currentPage.toLowerCase() === "adddevice") ? <AddNewDeviceForm navigator={setPage}  setShowBottomBar={setShowBottomBar} selectedUser={selectedUser} setSelectedUser={setSelectedUser}/> : "" }
        {/* COMMAND */}
